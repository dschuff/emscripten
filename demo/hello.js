...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "_strftime": _strftime, "_pthread_cond_wait": _pthread_cond_wait, "___syscall54": ___syscall54, "_abort": _abort, "__ZSt18uncaught_exceptionv": __ZSt18uncaught_exceptionv, "___buildEnvironment": ___buildEnvironment, "_pthread_cond_broadcast": _pthread_cond_broadcast, "__addDays": __addDays, "_strftime_l": _strftime_l, "___setErrNo": ___setErrNo, "_sbrk": _sbrk, "___cxa_begin_catch": ___cxa_begin_catch, "_pthread_getspecific": _pthread_getspecific, "__arraySum": __arraySum, "___syscall91": ___syscall91, "_pthread_mutex_unlock": _pthread_mutex_unlock, "_pthread_once": _pthread_once, "_getenv": _getenv, "___map_file": ___map_file, "_pthread_key_create": _pthread_key_create, "___unlock": ___unlock, "__isLeapYear": __isLeapYear, "_pthread_setspecific": _pthread_setspecific, "___cxa_atexit": ___cxa_atexit, "___lock": ___lock, "___syscall6": ___syscall6, "_pthread_mutex_lock": _pthread_mutex_lock, "_atexit": _atexit, "___syscall140": ___syscall140, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "ABORT": ABORT, "___dso_handle": ___dso_handle };
...
var real___GLOBAL__I_000101 = asm["_GLOBAL__I_000101"]; asm["_GLOBAL__I_000101"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var real___GLOBAL__sub_I_iostream_cpp = asm["_GLOBAL__sub_I_iostream.cpp"]; asm["_GLOBAL__sub_I_iostream.cpp"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var __GLOBAL__sub_I_iostream_cpp = Module["__GLOBAL__sub_I_iostream_cpp"] = function() { return Module["asm"]["_GLOBAL__sub_I_iostream.cpp"].apply(null, arguments) };
